...
function StartTest() {
    ...
    const [sentenceButtonText, setSentenceButtonText] = useState("Start Sentence Test")
    ...
    return (
        <Container>
            <Button onClick={toggleVocabTest} variant="warning">{vocabButtonText}</Button>
            <Button onClick={toggleSentenceTest} variant="info">{sentenceButtonText}</Button>
            {showVocabTest ? (
